...
permalink: /projects/luxai-s01/
math: true
redirect_from:
  - /writeups/LuxAIs01.html
---
...
The rest of the write up is organized as follows. First, I present the greedy heuristic agent and the rules that govern its actions. Next, I introduce the rule-based reinforcement learning agent including the method, implementation, and result. Finally, I conclude with a comparison of the two agents and their performance. I will not exhaustively describe the rules of the LuxAI game except where they are relevant to the agent implementation. For a complete description of the game see the [official specifications](https://www.lux-ai.org/specs-2021){:target="_blank"}.
...
{% include embed/youtube.html id='EhBMUlbKdcs' %}
_Simple agent versus greedy heuristic agent._

{% include embed/youtube.html id='oK2osAKZfcA' %}
_Simple agent versus rule-based reinforcement learning agent._

{% include embed/youtube.html id='nzjTNWZdIdk' %}
_Greedy heuristic agent versus rule-based reinforcement learning agent._
