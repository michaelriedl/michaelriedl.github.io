...
categories: [Blog]
tags: [crypto]
description: "Review of the Bitaxe Gamma solo miner."
image: /assets/images/thumbs/bitaxe_thumb.png
redirect_from:
  - /2025/08/01/bitaxe.html
---
...
## Two Month Update
After two months of using the Bitaxe Gamma, I've had to replace the power supply that came with it. One day I noticed that the Bitaxe had powered off randomly and did not automatically restart. After trying a couple different things, I was able to determine that the power supply had failed. I was able to easily replace it with another compatible one that I got off Amazon. I would recommend that people stay away from this generic power supply that came with it. I have also seen this same one for sale on Amazon.

<div align="center">
<figure>
<img src="/assets/images/blogs/bitaxe_power.png" alt="Bitaxe Gamma Power Supply" style="width:50%">
</figure>
</div>
