...
<div class="w3-row w3-padding-32">
    <div class="w3-third">
        <img src="/assets/images/projects/smrt_clk/smrt_clk.jpg" class="w3-round w3-margin-bottom" alt="SMRT CLK" style="width:80%">
        <figcaption>A smart touchscreen clock / dashboard based on the Raspberry Pi
