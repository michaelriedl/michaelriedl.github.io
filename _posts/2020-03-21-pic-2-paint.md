...
<div class="w3-row w3-padding-32 w3-center">
    ...
    <div class="w3-third">
        <img src="/assets/images/blogs/hard_scene_output.png" class="w3-round w3-margin-bottom" alt="Content Image" style="width:80%">
        <figcaption>Content Image</figcaption>
    </div>
    <div class="w3-third">
        <img src="/assets/images/blogs/hard_output_color.png" class="w3-round w3-margin-bottom" alt="Content Image" style="width:80%">
        <figcaption>Content Image</figcaption>
    </div>
</div>
